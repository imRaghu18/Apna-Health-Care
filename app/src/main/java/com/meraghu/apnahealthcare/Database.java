...
public class Database extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
      String qry1="create table Users(username,email,password)";
      sqLiteDatabase.execSQL(qry1);

        String qry2="create table cart(username,product,price,otype)";
        sqLiteDatabase.execSQL(qry2);

        String qry3="create table orderplace (username,fullname,address,contact,pincode,date,time,amount,otype)";
